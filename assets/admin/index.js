...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup() {
    ...
    const syncing = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)(false);
...
const FeedbackList = {
  ...
  setup() {
    ...
    const perPage = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)(10);
    const loading = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)(false);
    const editing = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.reactive)({});
    const load = async () => {
      loading.value = true;
      try {
        const data = await api(`feedback?page=${page.value}&per_page=${perPage.value}`);
        items.value = data.items || [];
        total.value = data.total || 0;
      } finally {
        loading.value = false;
    ...
    const deleteRow = async row => {
      if (!confirm(JRJ_ADMIN.i18n.areYouSure)) return;
      await api(`feedback/${row.id}`, {
        method: 'DELETE'
      });
      await load();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FeedbackList);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup() {
    const items = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)([]),
      loading = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)(false);
    const load = async () => {
      loading.value = true;
      try {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup() {
    const items = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)([]),
      total = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)(0),
      page = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)(1),
      perPage = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)(20),
      loading = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)(false);
    const filter = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.reactive)({
      event: ''
    });
...
/* harmony import */ var _components_LogsList_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/LogsList.js */ "./components/LogsList.js");
/* harmony import */ var _components_FeedbackList_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/FeedbackList.js */ "./components/FeedbackList.js");
...
const App = {
  ...
  setup() {
    ...
    const boot = window.__JAMROCK_BOOT_TAB && allowedTabs.includes(window.__JAMROCK_BOOT_TAB) ? window.__JAMROCK_BOOT_TAB : readTabFromUrl() || "settings";
    const tab = (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.ref)(boot);
    ...
    (0,vue_dist_vue_esm_bundler_js__WEBPACK_IMPORTED_MODULE_0__.onBeforeUnmount)(() => {
